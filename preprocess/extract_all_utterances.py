...
def get_parameter():
    ...
    parser.add_argument('-dataset', action="store", default="multiwoz")
...
def get_utterances_multiwoz(path, hack_map):
    ...
    for line in sen_intent_iob:
        ...
        if all(item == "O" for item in out_txt.split()):
            continue
...
if __name__ == '__main__':
    ...
    write_lines(out_path+dataset+"/"+"extract/", all_sentences, limit)
