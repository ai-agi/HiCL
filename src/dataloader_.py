from src.datareader_ import datareader, PAD_INDEX, domain2slot, y2_set
import torch
...
def get_dataloader(tgt_domain, batch_size, n_samples, data_path, tokenizer, use_dep, use_pos):
    ...
    domains = ['AddToPlaylist', 'BookRestaurant', 'GetWeather', 'PlayMusic', 'RateBook', 'SearchCreativeWork', 'SearchScreeningEvent', \
               'AddToPlaylist_unseen', 'BookRestaurant_unseen', 'GetWeather_unseen', 'PlayMusic_unseen', 'RateBook_unseen', 'SearchCreativeWork_unseen', 'SearchScreeningEvent_unseen', \
               'AddToPlaylist_seen', 'BookRestaurant_seen', 'GetWeather_seen', 'PlayMusic_seen', 'RateBook_seen', 'SearchCreativeWork_seen', 'SearchScreeningEvent_seen']
    ...
    # from preprocess.slu_preprocess import generate_seen_and_unseen_data
    # generate_seen_and_unseen_data(tgt_domain)
    ...
    if n_samples == 0:
        if use_dep and use_pos:
            ...
            # unseen
            unseen_data["domain"] = all_data[tgt_domain+'_unseen']["domain"]
            unseen_data["label"] = all_data[tgt_domain+'_unseen']["label"]
            unseen_data["utter"] = all_data[tgt_domain+'_unseen']["utter"]
            unseen_data["y"] = all_data[tgt_domain+'_unseen']["y"]
            unseen_data["utter_dep"] = all_data[tgt_domain+'_unseen']["utter_dep"]
            unseen_data["utter_pos"] = all_data[tgt_domain+'_unseen']["utter_pos"]
            unseen_data["gold_coarse_label"] = all_data[tgt_domain+'_unseen']["gold_coarse_label"]
            unseen_data["gold_fine_label"] = all_data[tgt_domain+'_unseen']["gold_fine_label"]

            # seen
            seen_data["domain"] = all_data[tgt_domain+'_seen']["domain"]
            seen_data["label"] = all_data[tgt_domain+'_seen']["label"]
            seen_data["utter"] = all_data[tgt_domain+'_seen']["utter"]
            seen_data["y"] = all_data[tgt_domain+'_seen']["y"]
            seen_data["utter_dep"] = all_data[tgt_domain+'_seen']["utter_dep"]
            seen_data["utter_pos"] = all_data[tgt_domain+'_seen']["utter_pos"]
            seen_data["gold_coarse_label"] = all_data[tgt_domain+'_seen']["gold_coarse_label"]
            seen_data["gold_fine_label"] = all_data[tgt_domain+'_seen']["gold_fine_label"]
